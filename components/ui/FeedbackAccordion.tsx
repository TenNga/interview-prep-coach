...
export const FeedbackAccordion:React.FC<FeedbackAccordionProps> = ({response}) => {
    return(
      ...
      <AccordionItem value="item-1" className="border-gray-600">
        <AccordionTrigger className="capitalize font-semibold">clarity score: {response?.clarity?.score}</AccordionTrigger>
        <AccordionContent>
        {response.clarity?.feedback}
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2" className="border-gray-600">
        <AccordionTrigger className="capitalize font-semibold">depth score: {response.depth?.score}</AccordionTrigger>
        <AccordionContent>
        {response.depth?.feedback}
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3" className="border-none">
        <AccordionTrigger className="capitalize font-semibold">Relevance score: {response.relevance?.score}</AccordionTrigger>
        <AccordionContent>
